...
namespace DAL.EF
{
    ...
    public class KnowledgeAccountingDbInitializer : DropCreateDatabaseIfModelChanges<KnowledgeAccountingContext>
    {
        protected override void Seed(KnowledgeAccountingContext db)
        {
            ...
            var admin = new ApplicationUser { UserName = "hardy4787", Email = "hardy@gmail.com" };
            ...
            //        }
            //    },
            //    new ProgrammerProfile{ FullName = "Basenko Ivan", Age = 22, Address = "Kiev", Email = "bullhardyua@gmail.com", GitHub = "hardy4787", Phone="+380652805738",
            //        Educations = new List<Education>(){
            //            educations[1]
            //        },
            //        Projects = new List<Project>(){
