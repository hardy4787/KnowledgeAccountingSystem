...
namespace BLL.Services
{
    ...
    //        return Mapper.Map<ProgrammerProfile, ProgrammerDTO>(programmer);
    //    }
    ...
    //        return Mapper.Map<IEnumerable<ProgrammerProfile>, IEnumerable<ProgrammerDTO>>(programmers);
    //    }
    ...
    //    {
    //        Database.Programmers.Insert(Mapper.Map<ProgrammerDTO, ProgrammerProfile>(programmer));
    //        Database.Save();
    //    }

    //    public void Update(ProgrammerDTO item)
    //    {
    //        Database.Programmers.Update(Mapper.Map<ProgrammerDTO, ProgrammerProfile>(item));
    //        Database.Save();
    //    }
    //    public void Dispose()
    //    {
